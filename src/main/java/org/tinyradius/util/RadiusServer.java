...
package main.java.org.tinyradius.util;
...
import main.java.org.tinyradius.packet.AccountingRequest;
...
public abstract class RadiusServer {
	 ...
	 *
	 * NOTE - ANDREW ROBERTS:
	 * I think this is the most appropriate place to place a custom authentication plugin.
	 * We could also hardcode it into accessRequestReceived(), but here is a more modular approach.
	 */
